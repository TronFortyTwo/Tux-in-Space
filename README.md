...
Elsewhere, you can compile the program easyly whit "gcc -lm -Wall -o -g main.c destination_file" in the master directory. You are encouraged of start use and test this program.
