 ...
 */
tcolor color_Scan(tcolor range_min, tcolor range_max) {
	...
	do {
		...
		var[1] = &range_min.red;
		var[2] = &range_max.red;
		OPS_Error("The value %i that you have put is wrong. Correct values are between %i and %i. Type another value for the red component of the color", var);
		scanf("%d", &color.red);
	}
	while(1);
	// green
	...
	OPS("Put the value of the green:\n&tdThe value must be between %i and %i", var);
	scanf("%d", &color.green);
	do {
		...
		OPS_Error("The value %i that you have put is wrong. Correct values are between %i and %i. Type another value for the green component of the color", var);
		scanf("%d", &color.green);
	}
	while(1);
	// blue
 ...
 */
BYTE color_CheckRange(tcolor color, tcolor min, tcolor max) {
